% Calculate time evolving aSMB at a given initial geometry
...
nco1=ncload(['../Models/OBS/sftgif_05000m.nc']);
...
%    shade(aSMB_b)
    ...
    ncwrite_GrIS_aSMB(ancfile, aSMB_re, 'aSMB', {'x','y','t'}, 5, timestamp, time_bounds);
