...
# Long-term average
ncra -O  MARv3.9-yearly-${gcm}-1960-1989.nc SMB_MARv3.9-yearly-${gcm}-ltm1960-1989.nc

# Copy to destination
/bin/cp SMB_MARv3.9-yearly-${gcm}-ltm1960-1989.nc ../../Data/RCM/

# Extract topg
ncks -O -v SRF SMB_MARv3.9-yearly-${gcm}-ltm1960-1989.nc ../../Data/RCM/topg_MARv3.9_05000m.nc
ncrename -v SRF,topg ../../Data/RCM/topg_MARv3.9_05000m.nc
